...
public class Author extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            if(k==1){
                JOptionPane.showMessageDialog(this, "Tác giả đã được cập nhật");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            if(k==1){
                JOptionPane.showMessageDialog(this, "Tác giả đã bị xóa");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
            pst = con.prepareStatement("select * from author where id LIKE ? OR name LIKE ? OR address LIKE ? OR phone LIKE ? ");
